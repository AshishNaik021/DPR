//
//  PatientSymptomHistoryViewController.m
//  Medico
//
...
#import "PatientSymptomHistoryCell.h"

@interface PatientSymptomHistoryViewController ()

@end

@implementation PatientSymptomHistoryViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    NSLog(@"PatientSymptomHistoryViewController.m");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PatientSymptomHistoryCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
