//
//  PatientDiagnosisHistoryViewController.m
//  Medico
//
...
#import "PatientDiagnosisHistoryCell.h"

@interface PatientDiagnosisHistoryViewController ()

@end

@implementation PatientDiagnosisHistoryViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    NSLog(@"PatientDiagnosisHistoryViewController.m");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    PatientDiagnosisHistoryCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
